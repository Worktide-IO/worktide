 ...
 */
final class Version20260722225020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5A543ED6A7 FOREIGN KEY (source_workspace_id) REFERENCES workspaces (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5A3930177E FOREIGN KEY (source_product_id) REFERENCES products (id) ON DELETE SET NULL');
